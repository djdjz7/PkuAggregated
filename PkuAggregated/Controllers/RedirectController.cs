...
namespace PkuAggregated.Controllers
{
    ...
    public class RedirectController : ControllerBase
    {
        [HttpGet]
        [Route("portal")]
        public void RedirectPortalAppAsync([FromServices] PortalApps portalApps, [FromQuery] string url)
        {
            ...
            var cookies = portalApps.CookieContainer.GetCookies(new Uri("https://portal.pku.edu.cn/portal2017/"));
